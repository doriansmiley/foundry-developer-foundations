...
import { CalendarContext, ScheduleMeetingOutput } from '@xreason/types';
...
export async function scheduleMeeting(calendar: calendar_v3.Calendar, context: CalendarContext): Promise<ScheduleMeetingOutput> {
    console.log(`${LOG_PREFIX} Processing meeting request:\n  summary: ${context.summary}\n  attendees: ${JSON.stringify(context.attendees, null, 2)}`);
    ...
    console.log(`${LOG_PREFIX} Meeting Created:\n  calendar returned: ${JSON.stringify({
        id: data.id,
