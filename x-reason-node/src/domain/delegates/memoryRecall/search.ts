import { FoundryClient, MemoryRecall } from "@xreason/types";
...
export async function searchMemoryRecall(input: string, kValue: number, client: FoundryClient): Promise<MemoryRecall[]> {
