...
import { deriveWindowFromTimeframe } from '@xreason/services/delegates/gsuite/deriveWindowFromTimeframe';
import { MeetingRequest } from '@xreason/types';
...
describe('deriveWindowFromTimeframe', () => {
    ...
    function expectWallClock(date: Date, y: number, m: number, d: number, hh: number, mm: number) {
    ...
    function mondayOfWeek(d: Date): Date {
        ...
        const mon = new Date(x); mon.setDate(x.getDate() + delta);
