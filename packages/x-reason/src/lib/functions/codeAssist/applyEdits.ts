...
export async function applyEdits(
    ...
    const edits = (typeof context[generateEditMachineId] === 'string') ? JSON.parse(context[generateEditMachineId]) as { ops: EditOp[] } : context[generateEditMachineId] as { ops: EditOp[] };
