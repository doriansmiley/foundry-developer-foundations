...
// Todo: refactor it to be in Google Service Types
import { GSuiteCalendarService } from '@codestrap/developer-foundations-types';

import { findOptimalMeetingTime } from '../functions/calendar/findOptimalMeetingTime';
import { scheduleMeeting } from '../functions/calendar/scheduleMeeting';
import { sendEmail } from '../functions/gmail/sendEmail';
import { readEmailHistory } from '../functions/gmail/readEmailHistory';
import { watchEmails } from '../functions/gmail/watchEmails';
